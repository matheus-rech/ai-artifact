...
import type { AgentExecutionStatus, AgentType } from '@/agents/base/AgentTypes';
import { cn } from '@/utils';

interface AgentStatusIndicatorProps {
  statuses: Record<AgentType, AgentExecutionStatus>;
  isAnalyzing: boolean;
...
export const AgentStatusIndicator: React.FC<AgentStatusIndicatorProps> = ({
  ...
  const getStatusIcon = (status: AgentExecutionStatus): React.ReactNode => {
    switch (status) {
      case 'completed':
  ...
  const agentEntries = Object.entries(statuses) as [AgentType, AgentExecutionStatus][];
